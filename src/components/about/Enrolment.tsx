...
const Enrolment: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-100 to-yellow-200 px-6 py-12">
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        <p className="text-center text-lg text-gray-700 max-w-3xl mx-auto">
          At <strong>NextGen Independent Online School</strong>, enrolment is designed to be 
          <strong>fast, secure, and stress-free</strong>. In just a few clicks, your child can 
          begin their journey into a world of STEM learning and future opportunities.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition">
            ...
            <p className="text-gray-700 text-sm">
              ...
              Choose between <strong>monthly, quarterly, or yearly</strong> options — all safe and transparent.
            </p>
          </div>
          ...
          <div className="p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition">
            ...
            <p className="text-gray-700 text-sm">
              Once payment is confirmed, learners are <strong>instantly onboarded</strong> into Google Classroom 
              with access to subjects, timetables, and teachers.
            </p>
          </div>
        </div>
        ...
        <div className="text-center mt-12">
          <p className="text-xl font-bold text-yellow-800">
            Enrol today and open the door to <span className="text-yellow-600">STEM excellence</span> for your child.
          </p>
          <Link
            to="/login"
            className="inline-block mt-6 bg-yellow-600 text-white px-6 py-3 rounded-lg shadow hover:bg-yellow-700 transition"
          >
            Start Enrolment Now
          </Link>
        </div>
